      ...
      <section class="bg-gray-50 dark:bg-gray-900">
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
          ...
          >
            <img
              class="w-8 h-8 mr-2"
              src="https://media.licdn.com/dms/image/C4D0BAQHCbQwsWJdmGw/company-logo_200_200/0/1645746283332/vktechno_solution_logo?e=2147483647&v=beta&t=AKqLl4hNjpnY0j-ip-6VJeeqtZOUQqKQMe3pwGLwgxQ"
              alt="logo"
            />
            Vk Techno Solutions
          </a>
